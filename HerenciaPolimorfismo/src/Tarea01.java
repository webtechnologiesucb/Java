...
class Simulador {
    ...
    public void mostrarResultados() {
        ...
        System.out.println("Partidas ganadas: " + juegosGanados + " (" + String.format("%.2f", porcentajeGanados) + "%)");
        System.out.println("Partidas perdidas: " + juegosPerdidos + " (" + String.format("%.2f", porcentajePerdidos) + "%)");
    }
}
