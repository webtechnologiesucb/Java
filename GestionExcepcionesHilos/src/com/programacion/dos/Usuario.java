...
public class Usuario{
	public static void main(String...args) {
		...
		listado.add(new UsuarioModel(1, "Miguel", "Pacheco", "Arteaga", new Date(), "admin", "4dm1n123", true));
		listado.add(new UsuarioModel(2,"Leticia", "Martinez", "Garcia",	new Date(), "lgarcia", "L3ti2024", true));
		listado.add(new UsuarioModel(3,"Daniela", "Toledo", "Abastoflor", new Date(), "dtoledo", "D4ni2024", true));
