 ...
 * @author Jaime Chura
 */
@WebServlet(name = "Servlet_EvaluacionPostulante", urlPatterns = {"/Servlet_EvaluacionPostulante"})
public class Servlet_EvaluacionPostulante extends HttpServlet {
 private static final org.apache.logging.log4j.Logger LOGGER = LogManager.getLogger(Servlet_EvaluacionPostulante.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        LOGGER.debug("Bienvenido al metodo del servlet que genera el PDF (EvaluacionPostulante)..");
        ...
        String name = "evaluacionPostulanteCPS";//nombre del recurso de generacion del reporte
