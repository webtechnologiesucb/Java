 ...
 * @author Jaime Chura
 */
@WebServlet(name = "Servlet_RespuestasIPVPostulante", urlPatterns = {"/Servlet_RespuestasIPVPostulante"})
public class Servlet_RespuestasIPVPostulante extends HttpServlet {
 private static final org.apache.logging.log4j.Logger LOGGER = LogManager.getLogger(Servlet_RespuestasIPVPostulante.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        LOGGER.debug("Bienvenido al metodo del servlet que genera el PDF (RespuestasPostulante IPV)..");
        ...
        String name = "respuestasPostulanteIPV";//nombre del recurso de generacion del reporte
