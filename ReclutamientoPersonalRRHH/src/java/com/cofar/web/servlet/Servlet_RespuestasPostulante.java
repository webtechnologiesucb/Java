 ...
 * @author Jaime Chura
 */
@WebServlet(name = "Servlet_RespuestasPostulante", urlPatterns = {"/Servlet_RespuestasPostulante"})
public class Servlet_RespuestasPostulante extends HttpServlet {
 private static final org.apache.logging.log4j.Logger LOGGER = LogManager.getLogger(Servlet_RespuestasPostulante.class);
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        LOGGER.debug("Bienvenido al metodo del servlet que genera el PDF (RespuestasPostulante)..");
        ...
        String name = "respuestasPostulante";//nombre del recurso de generacion del reporte
