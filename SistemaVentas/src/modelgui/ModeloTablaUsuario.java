...
public class ModeloTablaUsuario extends ModeloTabla {
	...
	private String[] nColumnas = { "Dni", "Codigo", "Login", "Nombre", "Apellidos", "Telefono", "Cargo",
			"Fecha Registro" };
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		switch (columnIndex) {
		case 0:
			return ((Usuario) registros.get(rowIndex)).getDni();
		case 1:
			return ((Usuario) registros.get(rowIndex)).getCodigo();
		case 2:
			return ((Usuario) registros.get(rowIndex)).getLogin();
		case 3:
			return ((Usuario) registros.get(rowIndex)).getNombre();
		case 4:
			return ((Usuario) registros.get(rowIndex)).getApellidos();
		case 5:
			return ((Usuario) registros.get(rowIndex)).getFono();
		case 6:
			return ((Usuario) registros.get(rowIndex)).getTipoCargo();
		case 7:
			return Helper.getFechaFormateada(new Date(((Usuario) registros.get(rowIndex)).getFecRegistro()),
					Helper.DIA_MES_ANIO);
		default:
			return null;
		}
