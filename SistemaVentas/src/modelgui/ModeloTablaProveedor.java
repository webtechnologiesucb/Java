...
public class ModeloTablaProveedor extends ModeloTabla {
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		switch (columnIndex) {
		case 0:
			return ((Proveedor) registros.get(rowIndex)).getRuc();
		case 1:
			return ((Proveedor) registros.get(rowIndex)).getRazonSocial();
		case 2:
			return ((Proveedor) registros.get(rowIndex)).getDireccion();
		case 3:
			return ((Proveedor) registros.get(rowIndex)).getTelefono();
		default:
			return null;
		}
	}
