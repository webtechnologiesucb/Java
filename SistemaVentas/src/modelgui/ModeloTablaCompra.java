...
public class ModeloTablaCompra extends ModeloTabla {
	...
	public ModeloTablaCompra() {
		...
		this.nombreColumnas = new String[] { "Encargado", "Tipo Documento", "Nro. Documento", "Items", "SubTotal",
				"Total", "Fecha", "Estado", "Observacion" };
	...
	public Object getValueAt(int rowIndex, int columnIndex) {
		...
		switch (columnIndex) {
		case 0:
			return compra.getIdUsuario().getNombre();
		case 1:
			return compra.getTipoDocumento();
		case 2:
			return compra.getNumeroDocumento();
		case 3:
			return compra.getNumeroItems();
		case 4:
			return compra.getSubtotla();
		case 5:
			return compra.getTotal();
		case 6:
			return Helper.getFechaFormateada(compra.getFecha(), Helper.DIA_MES_ANIO);
		case 7:
			return compra.getEstado();
		case 8:
			return compra.getObservaciones();
		default:
			return null;
		}
	}
