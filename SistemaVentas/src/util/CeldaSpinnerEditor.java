		...
		ChangeListener listener = new ChangeListener() {
			...
			public void stateChanged(ChangeEvent e) {
				...
				if (vi != null) {
					int sd = -1;
					if (nv < vi) {
						sd = JOptionPane.showConfirmDialog(null,
								"La cantidad Ingresada es menor " + "que la cantidad actual\n"
										+ "¿Realmente desea realizar este Cambio?",
								"Valor inferior al actual", JOptionPane.WARNING_MESSAGE);
