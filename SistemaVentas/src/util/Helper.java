...
public class Helper {
	...
	public static synchronized String generarCodigo(String cadena, String prefijo) {
		...
		if (prefijo != null) {
			...
			if (!pre.equals(pre2)) {
				throw new ExceptionValoresNoIgual(
						"El prefijo: " + pre2 + " de la cadena " + cadena + " no coincide con el prefijo " + pre);
			}
	 ...
	 *                       <li>NUM_LETRAS: una mesclas de SOLO_NUMEROS y
	 *                       SOLO_LETRAS</li>
	 *                       <li>DEFAULT: permitira casi cualquier caracter</li>
	 *                       </ul>
	 * @param lgCadena       longitud maxima de la cadena. pasar cero(0) si la
	 *                       cedena es iliminada
	 * @param espcBlco       <code>true</code> para que se permita espacios en
	 *                       blanco.
	 */
