...
public class ECampos {
	 ...
	 * @param excepcion componentes que seran ignorados: pasar null si no se desea
	 *                  que ningun objeto sea ignorado
	 */
	 ...
	 */
	public static void setEditableTexto(Component cm, boolean habilitar, Component[] excepcion, boolean limpiar,
			String valor) {
		if (cm instanceof JPanel) {
	...
	private static void habilitarTexto(Component[] cmps, boolean habilitar, Component[] excepcion, boolean limpiar,
			String valor) {
		for (int i = 0; i < cmps.length; i++) {
