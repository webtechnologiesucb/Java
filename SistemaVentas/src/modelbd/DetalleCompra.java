...
public class DetalleCompra extends JAbstractModelBD implements Serializable, IModel, Cloneable {
	...
	public DetalleCompra(Integer id, Compra idcompra, Producto idProducto, Integer cantidad, Double importe,
			Double descuento, Integer activo) {
		this.id = id;
	...
	public DetalleCompra(Compra idcompra, Producto idProducto, Integer cantidad, Double importe, Double descuento,
			Integer activo) {
		this.idcompra = idcompra;
		this.idProducto = idProducto;
		this.cantidad = cantidad;
