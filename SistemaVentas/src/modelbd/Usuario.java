...
public class Usuario extends JAbstractModelBD implements Serializable, IModel {
	 ...
	 * @param fecRegistro
	 */
	public Usuario(String dni, String codigo, String login, String nombre, String apellidos, String clave, String salt,
			String fono, String sexo, String tipoCargo, long fecRegistro) {
		this.dni = dni;
		this.codigo = codigo;
		this.login = login;
		this.nombre = nombre;
	...
	public Usuario(Integer idu, String dni, String codigo, String login, String nombre, String apellidos, String clave,
			String salt, String fono, String sexo, String tipoCargo, long fecRegistro) {
		this.idu = idu;
		this.dni = dni;
		this.codigo = codigo;
		this.login = login;
	...
	public Usuario(Integer idu, String dni, String codigo, String login, String nombre, String apellidos,
			FileInputStream foto, String clave, String salt, Integer fechaNacimiento, String fono, String fono2,
			String celular, String nextel, String email, String sexo, String tipoCargo, String descipcion,
			Integer activo, long fecRegistro, long fecBaja, boolean activoBool) {
		this.idu = idu;
		this.dni = dni;
		this.codigo = codigo;
		this.login = login;
	...
	public Usuario(String dni, String codigo, String login, String nombre, String apellidos, FileInputStream foto,
			String clave, String salt, Integer fechaNacimiento, String fono, String fono2, String celular,
			String nextel, String email, String sexo, String tipoCargo, String descipcion, Integer activo,
			long fecRegistro, long fecBaja, boolean activoBool) {
		this.dni = dni;
		this.codigo = codigo;
		this.login = login;
		this.nombre = nombre;
	...
	public void encriptarPass() {
		StringBuilder sb = new StringBuilder(this.dni + this.nombre.length() + this.codigo);
	...
	public Object[] llenarValores() {
		Object[] valores = { this.getDni(), this.getCodigo(), this.getLogin(), this.getNombre(), this.getApellidos(),
				this.getFechaNacimiento(), this.getFono(), this.getFono2(), this.getCelular(), this.getNextel(),
				this.getEmail(), this.getSexo(null), this.getTipoCargo(), this.getDescipcion(), this.getActivo(),
				this.getFecRegistro(), this.getFecBaja(), this.getPrimaryKey() };
		return valores;
	}
}
