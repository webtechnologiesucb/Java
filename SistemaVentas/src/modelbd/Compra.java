...
public class Compra extends JAbstractModelBD implements Serializable, IModel {
	...
	public Compra(Integer id, String tipoDocumento, String numeroDocumento, Proveedor idProveedor, Usuario idUsuario,
			Moneda idMoneda, String estado, Integer numeroItems, String observaciones, Double subtotla, Integer igv,
			Double total, Date fecha, Integer activo) {
		this.id = id;
	...
	public Compra(String tipoDocumento, String numeroDocumento, Proveedor idProveedor, Usuario idUsuario,
			Moneda idMoneda, String estado, Integer numeroItems, String observaciones, Double subtotla, Integer igv,
			Double total, Date fecha, Integer activo) {
		this.tipoDocumento = tipoDocumento;
		this.numeroDocumento = numeroDocumento;
	...
	public Compra(String tipoDocumento, String numeroDocumento, Proveedor idProveedor, Usuario idUsuario,
			Moneda idMoneda, String estado, Integer numeroItems, Double subtotla, Double total, Date fecha) {
		this.tipoDocumento = tipoDocumento;
		this.numeroDocumento = numeroDocumento;
		this.idProveedor = idProveedor;
		this.idUsuario = idUsuario;
