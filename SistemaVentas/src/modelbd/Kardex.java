...
public class Kardex extends JAbstractModelBD implements Serializable, IModel {
	...
	public Kardex(Integer idKardex, Producto producto, Date Fecha, String documento, String numeroDeDocumento,
			Integer entrada, Integer salida, Double precio, Double valor, Integer StockActual, Double valorTotal,
			Integer activo) {
	...
	public Kardex(Producto producto, Date Fecha, String documento, String numeroDeDocumento, Integer entrada,
			Integer salida, Double precio, Double valor, Integer StockActual, Double valorTotal) {
		this.producto = producto;
		this.Fecha = Fecha;
		this.documento = documento;
		this.numeroDeDocumento = numeroDeDocumento;
