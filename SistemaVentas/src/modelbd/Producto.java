...
public class Producto extends JAbstractModelBD implements Serializable, IModel, Cloneable {
	...
	public Producto(Integer idProducto, String codigoBarras, String codigo, String nombre, Double costo,
			Double precioAlMayor, Double precioAlMenor, Integer utilidad, Integer stockMinimo, String tipo,
			Integer idMoneda) {
	...
	public Producto(String codigoBarras, String codigo, String codigoDelFabricante, String nombre, Double costo,
			Double precioAlMayor, Double precioAlMenor, Integer utilidad, Integer aplicaIGV, Integer stockMinimo,
			String tipo, Integer idMoneda, FileInputStream imagen, Integer idClase, Integer idMarca, Integer idModelo,
			String ubicacion, String unidadPrincipal, Double peso) {
		this.codigoBarras = codigoBarras;
		this.codigo = codigo;
	...
	public Producto(String codigoBarras, String codigo, String codigoDelFabricante, String nombre, Double costo,
			Double precioAlMayor, Double precioAlMenor, Integer utilidad, Integer aplicaIGV, Integer stockMinimo,
			String tipo, Integer idMoneda, Integer idClase, Integer idMarca, Integer idModelo, String ubicacion,
			String unidadPrincipal, Double peso) {
		this.codigoBarras = codigoBarras;
		this.codigo = codigo;
		this.codigoDelFabricante = codigoDelFabricante;
		this.nombre = nombre;
	...
	public Object[] llenarValores() {
		...
		Object[] valores = { this.getCodigoBarras(), this.getCodigo(), this.getCodigoDelFabricante(), this.getNombre(),
				this.getCosto(), this.getPrecioAlMayor(), this.getPrecioAlMenor(), this.getUtilidad(),
				this.getAplicaIGV(), this.getStockMinimo(), this.getTipo(), this.getIdMoneda(), this.getIdClase(),
				this.getIdMarca(), this.getIdModelo(), this.getUbicacion(), this.getUnidadPrincipal(), this.getPeso(),
				this.getActivo(), this.getPrimaryKey() };

		if (this.getImagen(null) != null) {
			campos = Producto.CAMPOS_NO_ID;
			valores = new Object[] { this.getCodigoBarras(), this.getCodigo(), this.getCodigoDelFabricante(),
					this.getNombre(), this.getCosto(), this.getPrecioAlMayor(), this.getPrecioAlMenor(),
					this.getUtilidad(), this.getAplicaIGV(), this.getStockMinimo(), this.getTipo(), this.getIdMoneda(),
					this.getImagen(null), this.getIdClase(), this.getIdMarca(), this.getIdModelo(), this.getUbicacion(),
					this.getUnidadPrincipal(), this.getPeso(), this.getActivo(), this.getPrimaryKey() };
		}
