...
public class IProducto extends javax.swing.JInternalFrame {
	...
	private void initComponents() {
		...
		ftxtStockMinimo.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(
		...
		ftxtPeso.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(
		...
		jPanel4.setBorder(
				javax.swing.BorderFactory.createTitledBorder(null, "FOTO", javax.swing.border.TitledBorder.CENTER,
		...
		jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tipo de Producto",
		...
		ftxtUtilidad.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(
				new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0"))));
		...
		ftxtCosto.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(
				new javax.swing.text.NumberFormatter(new FormatoDecimal("#,##0.00", true))));
		...
		ftxtPrecioAlMayor.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(
				new javax.swing.text.NumberFormatter(new FormatoDecimal("#,##0.00", true))));
		...
		ftxtPrecioAlMenor.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(
				new javax.swing.text.NumberFormatter(new FormatoDecimal("#,##0.00", true))));
	...
	private void bntSelecFotoActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_bntSelecFotoActionPerformed
		...
		if (estado == JFileChooser.APPROVE_OPTION) {
			try {
				...
				Image icono = ImageIO.read(imagen).getScaledInstance(pnlImagen.getWidth(), pnlImagen.getHeight(),
						Image.SCALE_AREA_AVERAGING);
				tn = new Thumbnail(icono, System.getProperty("user.dir") + "/" + se.getSelectedFile().getName());
				imagen = tn.generarThumbnail();
				this.pnlImagen
						.setIcon(new ImageIcon(System.getProperty("user.dir") + "/" + se.getSelectedFile().getName()));
				this.pnlImagen.updateUI();
	...
	private void bntGuardarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_bntGuardarActionPerformed
		...
		if (this.txtCodigo.getText().isEmpty()) {
			JOptionPane.showInternalMessageDialog(this, "Ingrese un codigo para el producto", "No deje campos vacios",
		...
		if (this.cmbTipoMoneda.getSelectedItem() == null) {
			JOptionPane.showInternalMessageDialog(this, "Seleccione un Tipo de Moneda", "No deje campos vacios",
					JOptionPane.ERROR_MESSAGE);
				...
				if (controllerProducto.existeCodigoBarras(txtCodigoBarras.getText())) {
					JOptionPane.showInternalMessageDialog(this, "El Codigo de Barras: " + txtCodigoBarras.getText(),
							". Ya ha sido asignado a otro Producto.\n" + "Porfavor Ingrese Otro Codigo de Barras.\n"
									+ "si desea no ingrese ningun codigo de barras",
							JOptionPane.ERROR_MESSAGE);
					txtCodigo.requestFocus();
					return;
				}
	...
	private void bntEliminarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_bntEliminarActionPerformed
		...
		int nu = JOptionPane.showInternalConfirmDialog(this,
				(plpa.total != null ? plpa
						: "¿Realmente desea Eliminar\n producto " + product.getNombre() + "Con codigo: "
								+ product.getCodigo()),
		...
		if (op > 0) {
			JOptionPane.showInternalMessageDialog(this, "Producto Eliminado Correctamente", "Productos Borrado",
	...
	private void guardarProducto(boolean conImagen) {
		...
		if (gr) {
			...
			JOptionPane.showInternalOptionDialog(this, pvc, "Registro Guardado. ¿Desea Ingresar Cantidades?",
					JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, new Object[] { aviso }, null);
			if (pvc.isAceptado()) {
				int grabarDatos = pvc.grabarDatos();
				if (grabarDatos > 0) {
					JOptionPane.showInternalMessageDialog(this, "Cantidades registradas correctamente",
							"Cantidades Registradas", JOptionPane.INFORMATION_MESSAGE);
				}
			}
	...
	public void actualizarProductos(boolean conImagen) {
		if (product != null) {
			...
			if (gr != 0) {
				...
				aviso.setVisible(false);
				JOptionPane.showInternalOptionDialog(this, pvc,
						"Registro Actualizado. ¿Desea Modifcar las Cantidades existentes en los Almacenes?",
						JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE, null, new Object[] { aviso }, null);
				if (pvc.isAceptado()) {
					int grabarDatos = pvc.grabarDatos();
					if (grabarDatos > 0) {
						JOptionPane.showInternalMessageDialog(this, "Cantidades Actualizadas correctamente",
								"Cantidades Actualizadas", JOptionPane.INFORMATION_MESSAGE);
					}
