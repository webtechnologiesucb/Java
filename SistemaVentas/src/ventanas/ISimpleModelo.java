...
public class ISimpleModelo extends javax.swing.JInternalFrame {
	...
	private void cerrarVentana() {
		int opcion = JOptionPane.showInternalConfirmDialog(this,
				"Los Datos que no hayan sido guardado " + "se perderan.\n ¿Desea cerrar esta ventana?",
				"¿Desea cerrar esta ventana?", JOptionPane.YES_NO_CANCEL_OPTION, JOptionPane.WARNING_MESSAGE);
	...
	public void BorrarModelo() {
		if (tblModelo.getSelectedRow() != -1) {
			...
			if (br != 0) {
				JOptionPane.showInternalMessageDialog(this, "Modelo Eliminado", "Registro Borrado",
	...
	public void BorrarMarca() {
		if (tblMarca.getSelectedRow() != -1) {
			...
			if (br != 0) {
				JOptionPane.showInternalMessageDialog(this, "Marca Eliminada", "Registro Borrado",
						JOptionPane.ERROR_MESSAGE);
				tmarca = new ModeloTablaSimpleModelo(CSimpleModelo.OMARCA);
				tblMarca.setModel(tmarca);
			}
	...
	public void BorrarClase() {
		if (tblClase.getSelectedRow() != -1) {
			...
			if (br != 0) {
				JOptionPane.showInternalMessageDialog(this, "Clase Eliminada", "Registro Borrado",
						JOptionPane.ERROR_MESSAGE);
				tclase = new ModeloTablaSimpleModelo(CSimpleModelo.OCLASE);
				tblClase.setModel(tclase);
			}
	...
	public void grabarModelo(ActionEvent evt) {
		if (!txtModelo.getText().isEmpty()) {
			int op = JOptionPane.showInternalConfirmDialog(this, "Desea grabar el modelo:" + txtModelo.getText() + "?",
					"¿Grabar Modelo?", JOptionPane.YES_NO_CANCEL_OPTION);
			...
			if (op == JOptionPane.OK_OPTION) {
				...
				if (guardarRegistro) {
					JOptionPane.showInternalMessageDialog(this,
							"Modelo: " + txtModelo.getText() + " Guardado Correctamente", "Modelo guardado",
	...
	public void grabarMarca(ActionEvent evt) {
		...
		if (!txtMarca.getText().isEmpty()) {
			int op = JOptionPane.showInternalConfirmDialog(this, "Desea grabar la Marca:" + txtMarca.getText() + "?",
					"¿Grabar Marca?", JOptionPane.YES_NO_CANCEL_OPTION);
			...
			if (op == JOptionPane.OK_OPTION) {
				...
				if (guardarRegistro) {
					JOptionPane.showInternalMessageDialog(this,
							"Marca: " + txtModelo.getText() + " Guardado Correctamente", "Marca guardada",
							JOptionPane.INFORMATION_MESSAGE);
					tmarca = new ModeloTablaSimpleModelo(CSimpleModelo.OMARCA);
					tblMarca.setModel(tmarca);
					txtMarca.setText("");
	...
	public void grabarClase(ActionEvent evt) {
		if (!txtClase.getText().isEmpty()) {
			int op = JOptionPane.showInternalConfirmDialog(this, "Desea grabar la Clase:" + txtClase.getText() + "?",
					"¿Grabar Clase?", JOptionPane.YES_NO_CANCEL_OPTION);
			...
			if (op == JOptionPane.OK_OPTION) {
				...
				if (guardarRegistro) {
					JOptionPane.showInternalMessageDialog(this,
							"Clase: " + txtClase.getText() + " Guardada Correctamente", "Clase guardada",
							JOptionPane.INFORMATION_MESSAGE);
					tclase = new ModeloTablaSimpleModelo(CSimpleModelo.OCLASE);
					tblClase.setModel(tclase);
					txtClase.setText("");
			...
			if (tblModelo.getSelectedRow() != -1) {
				...
				if (!sp.getNombre().equals(txtModelo.getText())) {
					int op = JOptionPane.showInternalConfirmDialog(this,
							"Desea cambiar modelo:" + sp.getNombre() + " por " + txtModelo.getText() + "?",
							"¿Actualizar Modelo?", JOptionPane.YES_NO_CANCEL_OPTION);

					if (op == JOptionPane.OK_OPTION) {
						sp.setNombre(txtModelo.getText());
						int guardarRegistro = cGeneral.actualizarRegistro(sp);
						if (guardarRegistro != 0) {
							JOptionPane.showInternalMessageDialog(this, "Modelo: " + "Actualizado Correctamente",
									"Modelo actualizado", JOptionPane.INFORMATION_MESSAGE);
							tmodelo = new ModeloTablaSimpleModelo(CSimpleModelo.OMODELO);
							tblModelo.setModel(tmodelo);
							txtModelo.setText("");
						}
		...
		if (!txtMarca.getText().isEmpty()) {
			if (tblMarca.getSelectedRow() != -1) {
				...
				if (!sp.getNombre().equals(txtMarca.getText())) {
					int op = JOptionPane.showInternalConfirmDialog(this,
							"Desea cambiar la marca:" + sp.getNombre() + " por " + txtMarca.getText() + "?",
							"¿Actualizar Marca?", JOptionPane.YES_NO_CANCEL_OPTION);

					if (op == JOptionPane.OK_OPTION) {
						sp.setNombre(txtMarca.getText());
						int guardarRegistro = cGeneral.actualizarRegistro(sp);
						if (guardarRegistro != 0) {
							JOptionPane.showInternalMessageDialog(this, "Marca: " + "Actualizada Correctamente",
		...
		if (!txtClase.getText().isEmpty()) {
			if (tblClase.getSelectedRow() != -1) {
				...
				if (!sp.getNombre().equals(txtClase.getText())) {
					int op = JOptionPane.showInternalConfirmDialog(this,
							"Desea cambiar la Clase:" + sp.getNombre() + " por " + txtClase.getText() + "?",
							"¿Actualizar Clase?", JOptionPane.YES_NO_CANCEL_OPTION);

					if (op == JOptionPane.OK_OPTION) {
						sp.setNombre(txtClase.getText());
						int guardarRegistro = cGeneral.actualizarRegistro(sp);
						if (guardarRegistro != 0) {
							JOptionPane.showInternalMessageDialog(this, "Clase: " + "Actualizada Correctamente",
									"Clase actualizada", JOptionPane.INFORMATION_MESSAGE);
							tclase = new ModeloTablaSimpleModelo(CSimpleModelo.OCLASE);
							tblClase.setModel(tclase);
							txtClase.setText("");
						}
	...
	public void actualizarEstadoModelo(ActionEvent evt) {
		...
		if (tblModelo.getSelectedRow() != -1) {
			...
			if (sp.getActivo() == 0) {
				...
				int guardarRegistro = cGeneral.actualizarRegistro(sp);
				if (guardarRegistro != 0) {
					JOptionPane.showInternalMessageDialog(this, "Modelo: " + "Activado Correctamente",
							"Modelo activado", JOptionPane.INFORMATION_MESSAGE);
					tmodelo = new ModeloTablaSimpleModelo(CSimpleModelo.OMODELO);
					tblModelo.setModel(tmodelo);
					txtModelo.setText("");
				}
			} else {
				JOptionPane.showInternalMessageDialog(this, "Esta Modelo ya esta Activo", "Ya Esta Activado",
						JOptionPane.INFORMATION_MESSAGE);
	...
	public void actualizarEstadoMarca(ActionEvent evt) {
		if (tblMarca.getSelectedRow() != -1) {
			...
			if (sp.getActivo() == 0) {
				...
				int guardarRegistro = cGeneral.actualizarRegistro(sp);
				if (guardarRegistro != 0) {
					JOptionPane.showInternalMessageDialog(this, "Marca: " + "Activada Correctamente", "Marca activada",
							JOptionPane.INFORMATION_MESSAGE);
					tmarca = new ModeloTablaSimpleModelo(CSimpleModelo.OMARCA);
					tblMarca.setModel(tmarca);
					txtMarca.setText("");
				...
				JOptionPane.showInternalMessageDialog(this, "Esta Marca ya esta Activa", "Ya Esta Activado",
						JOptionPane.INFORMATION_MESSAGE);
	...
	public void actualizarEstadoClase(ActionEvent evt) {
		...
		if (tblClase.getSelectedRow() != -1) {
			...
			if (sp.getActivo() == 0) {
				...
				if (guardarRegistro != 0) {
					JOptionPane.showInternalMessageDialog(this, "Clase: " + "Actualizada Correctamente",
							"Clase Activada", JOptionPane.INFORMATION_MESSAGE);
					tclase = new ModeloTablaSimpleModelo(CSimpleModelo.OCLASE);
					tblClase.setModel(tclase);
					txtClase.setText("");
				} else {
					JOptionPane.showInternalMessageDialog(this, "Esta Clase ya esta Activa", "Ya Esta Activada",
							JOptionPane.INFORMATION_MESSAGE);
