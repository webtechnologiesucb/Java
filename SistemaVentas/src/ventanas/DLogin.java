...
public class DLogin extends javax.swing.JDialog {
	...
	private void initComponents() {
		...
		pnlConfig.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Configuración Predeterminada",
				javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Arial", 1, 12), java.awt.Color.white)); // NOI18N
		...
		tftTipoCambio.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(
	...
	private void bntIngresarActionPerformed(ActionEvent evt) {// GEN-FIRST:event_bntIngresarActionPerformed
		if (!this.txtUsuario.getText().isEmpty() && !String.copyValueOf(this.ptxtPass.getPassword()).isEmpty()) {
			String msg = "";
			// login usuario
			AppConfig.Estado configUsuario = AppConfig.configUsuario(this.txtUsuario.getText(),
					String.copyValueOf(this.ptxtPass.getPassword()));
			if (configUsuario == AppConfig.Estado.NO_EXISTE) {
				...
				ArrayList<EncargadoAlmacen> rEa = controllerEa
						.getRegistrosPorEncargado(AppConfig.getUsuario().getPrimaryKey());
				if (!rEa.isEmpty()) {
			...
			JOptionPane.showMessageDialog(null, "Ingrese un nombre de usuario y su contraseña", "Error: Datos vacios.",
