...
public class BuscarUsuario extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Tipo de Cargo",
		...
		jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Registrados",
				javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION,
				new java.awt.Font("Tahoma", 1, 12))); // NOI18N
	...
	private void bntBuscarFechasActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_bntBuscarFechasActionPerformed
		if (this.dcFechaInicio.getCalendar() != null) {
			...
			if (this.dcFechaFinal.getCalendar() != null) {
				...
				if (timeFin < time) {
					JOptionPane.showInternalMessageDialog(this, "La fecha final debe ser mayor que la fecha inicio",
							"Error: rango de fecha", JOptionPane.ERROR_MESSAGE);
				} else {
	...
	private void buttonRect5ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_buttonRect5ActionPerformed
		if (tblUsuarios.getSelectedRow() != -1) {
			...
			JOptionPane.showInternalMessageDialog(this, "Seleccione una fila de la tabla", "Selecciona una fila",
