	...
	private void buttonRect1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_buttonRect1ActionPerformed
		if (!txtDato.getText().isEmpty()) {
			...
			if (this.rbRuc.isSelected()) {
				...
				if (opcion != -1) {
					columnas = new String[] { ModeloTablaProveedor.cmpActivo(), ModeloTablaProveedor.cmpRuc() };
				...
				if (opcion != -1) {
					columnas = new String[] { ModeloTablaProveedor.cmpActivo(), ModeloTablaProveedor.cmpRazonSocial() };
					valores = new Object[] { opcion, txtDato.getText() };
				}
				...
				if (opcion != -1) {
					columnas = new String[] { ModeloTablaProveedor.cmpActivo(), ModeloTablaProveedor.cmpTelefono() };
					valores = new Object[] { opcion, txtDato.getText() };
				}
