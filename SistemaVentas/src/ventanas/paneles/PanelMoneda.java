...
public class PanelMoneda extends javax.swing.JPanel {
	...
	private void bntGrabarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_bntGrabarActionPerformed
		if (!txtNombre.getText().isEmpty() && !txtSimbolo.getText().isEmpty()) {
			int op = JOptionPane.showConfirmDialog(null,
					"¿Desea Guardar la moneda " + "con el nombre" + txtNombre.getText() + " y simbolo "
							+ txtSimbolo.getText() + " ?",
					"¿Desea agregar Moneda Nueva?", JOptionPane.YES_NO_CANCEL_OPTION);
	...
	private void bntModificarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_bntModificarActionPerformed
		if (!txtNombre.getText().isEmpty() && !txtSimbolo.getText().isEmpty()) {
			if (!seleccionada.getNombre().equals(txtNombre.getText())
					|| !seleccionada.getSimbolo().equals(txtSimbolo.getText())
					|| chbEstado.isSelected() != seleccionada.getActivoBool()) {
				int op = JOptionPane.showConfirmDialog(null,
						"¿Desea Cambiar la moneda " + seleccionada.getNombre() + " por " + txtNombre.getText() + " ?",
						"¿Desea Modifica Moneda?", JOptionPane.YES_NO_CANCEL_OPTION);
				if (op == JOptionPane.OK_OPTION) {
	...
	private void bntEliminarActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_bntEliminarActionPerformed
		if (lstMonedas.getSelectedIndex() != -1) {
			seleccionada = (Moneda) lstMonedas.getSelectedValue();
			int op = JOptionPane.showConfirmDialog(null, "¿Desea Eliminar la moneda " + seleccionada.getNombre() + " ?",
					"¿Eliminar Moneda?", JOptionPane.YES_NO_CANCEL_OPTION);
			if (op == JOptionPane.OK_OPTION) {
		...
		if (chbDefault.isSelected()) {
			...
			if (pre != null) {
				if (!pre.getPredeterminadoBool()) {
					int op = JOptionPane.showConfirmDialog(null,
							"¿Desea establecer esta moneda " + "como predeterminada", "Establecer como predeterminada",
