 ...
 * component. An auth manager is mainly responsible for providing role-based
...
public interface IAuthManager {
	 ...
	 * 
	 * @param itemName String the name of the operation that we are checking access
	 *                 to
	 * @param userId   Object the user ID. This should be either an integer or a
	 ...
	 * @return Autorizacion the authorization item throws Exception if an item with
	 ...
	 *               their type.
	 * @param userId object the user ID. Defaults to null, meaning returning all
	 ...
	 * @return Autorizacion the authorization item. Null if the item cannot be
	 *         found.
	 */
	 ...
	 * @param childName string the child item name throws CException if either
	 *                  parent or child doesn't exist or if a loop has been
	 *                  detected.
	 */
	 ...
	 * 
	 * @param itemName Object the parent item name. This can be either a string or
	 ...
	 *         throws CException if the item does not exist or if the item has
	 *         already been assigned to the user
	 */
	 ...
	 * executed when {@link checkAccess} is called.
	 * 
	 * @param bizRule string the business rule to be executed.
	 * @param params  HaspMap additional parameters to be passed to the business
	 *                rule when being executed.
	 * @param data    Object additional data that is associated with the
	 *                corresponding authorization item or assignment
	 * @return boolean whether the execution returns a true value. If the business
	 *         rule is empty, it will also return true.
	 */
